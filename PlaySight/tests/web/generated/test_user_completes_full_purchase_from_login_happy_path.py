...
Feature: User completes full purchase from login to checkout — happy path
...
def test_user_completes_full_purchase_from_login_happy_path(login_page, inventory_page, cart_page, checkout_page, e2e_data):
    """
    Scenario: Verify the primary success path for: User completes full purchase from login to checkout
