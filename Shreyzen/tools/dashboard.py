#!/usr/bin/env python3
"""
Shreyzen Analytics Dashboard — Beautiful PowerBI-style web dashboard.
...
app = FastAPI(title="Shreyzen Dashboard")
...
<title>Shreyzen — Analytics Dashboard</title>
...
<aside class="sb">
  <div class="brand">
    <div class="brand-logo">🎯 Shreyzen</div>
  ...
  <div class="sb-footer">Shreyzen v1.0 · Playwright + Python</div>
</aside>
...
def main():
    parser = argparse.ArgumentParser(description="Shreyzen Analytics Dashboard")
    parser.add_argument("--port", type=int, default=8766)
    parser.add_argument("--host", default="127.0.0.1")
    args = parser.parse_args()
    print(f"\n🎯 Shreyzen Dashboard running at http://{args.host}:{args.port}")
