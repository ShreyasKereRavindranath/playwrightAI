# Shreyzen — Multi-Provider LLM Layer

Shreyzen's AI features (self-healing locators, NL→test generation, test-repair,
...
Server on :1234). Shreyzen connects automatically once the server responds.
